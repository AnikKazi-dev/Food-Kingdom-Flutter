...
class AppColors {
  ...
  static final Color mainColor = Color.fromARGB(211, 43, 82, 255);
  //static final Color cardColor = Color.fromARGB(255, 116, 188, 255);
//static final Color mainColor = const Color(0xFFfa7552);
  static final Color iconColor1 = const Color(0xFFFffd28d);
